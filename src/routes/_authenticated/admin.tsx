...
import { SignupSettingsTab } from "@/components/admin/signup-settings-tab";
      ...
      {isClienteOnly ? (
        ...
        <Tabs defaultValue="dashboard" className="mt-6">
          <TabsList className="flex flex-wrap h-auto">
            ...
            <TabsTrigger value="signupSettings">Inscrições</TabsTrigger>
          ...
          <TabsContent value="signupSettings" className="mt-4"><SignupSettingsTab /></TabsContent>
