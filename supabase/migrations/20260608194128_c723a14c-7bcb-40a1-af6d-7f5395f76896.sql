...
ALTER TABLE public.companies ADD COLUMN IF NOT EXISTS registration_id text;
...
begin
  ...
  if coalesce(btrim(p_payload->>'registration_id'), '') = '' then raise exception 'registration_id required'; end if;
  ...
  if v_existing_company is null then
    ...
    values (
      ...
      btrim(p_payload->>'registration_id'),
    ...
    update public.companies set
      ...
      registration_id = btrim(p_payload->>'registration_id'),
