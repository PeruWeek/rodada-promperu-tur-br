-- Recria o trigger removendo a checagem obrigatória de preferred_language.
-- Idioma passa a ser opcional; demais regras seguem inalteradas.
...
BEGIN
  IF NEW.signup_completed_at IS NOT NULL
    ...
    SELECT id, company_id, full_name, job_title, whatsapp
      INTO v_profile
    ...
    END IF;
    -- preferred_language: OPCIONAL (não é mais bloqueante)
